...
@Slf4j
public class GenericDateTimeDeserializer extends StdDeserializer<LocalDate> {

    public GenericDateTimeDeserializer(Class<?> vc) {
        super(vc);
    }
    public GenericDateTimeDeserializer() {
        this(null);
    }
    @Override
